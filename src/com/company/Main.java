...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Catalog.getInstance().get_profesor("Fojica").adauga_serie(serie);
        Catalog.getInstance().get_profesor("Fojica").get_serie(25).get_grupa(2).adauga_student(Catalog.getInstance().get_student("Luca")).adauga_student(Catalog.getInstance().get_student("Stamate"));
        System.out.println(Catalog.getInstance().get_profesor("Fojica").get_serie(25).get_grupa(2));
    }
}
